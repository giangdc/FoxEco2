...
| SC-GIFT-006 | Màn "Quà đã nhận" rỗng khi chưa nhận quà nào — text "Chưa có quà nào" + subtitle (⚠ UPDATE 2026-07-31, C-ORD-06 Resolved — có ảnh chụp thật) | GIFT | Ảnh chụp thật app STG | P3 | UI | NEW | ✅ Đã update TC (2026-07-31) | — | — |
...
| SC-NTF-001 | Thông báo khi ghép ngay (NTF-01/02) + tap → điều hướng Theo dõi đơn (⚠ UPDATE 2026-07-31, 3 biến thể tách 3 TC) | NTF | DOC-v1.0-01 | P2 | Functional | NEW | ✅ Đã tạo TC (+3, 2026-07-31) | — | — |
| SC-NTF-002 | Thông báo khi khớp tuyến OFFER (NTF-03) + tap → điều hướng Chi tiết tin (⚠ UPDATE 2026-07-31) | NTF | DOC-v1.0-01 | P2 | Functional | NEW | ✅ Đã tạo TC (+1, 2026-07-31) | — | — |
| SC-NTF-003 | Thông báo theo mốc vận chuyển: lấy hàng/đã giao/hoàn tất (NTF-04/05/06) + tap → điều hướng Theo dõi đơn (⚠ UPDATE 2026-07-31, 3 mốc tách 3 TC) | NTF | DOC-v1.0-01 | P2 | Functional | NEW | ✅ Đã tạo TC (+3, 2026-07-31) | — | — |
| SC-NTF-004 | Thông báo khi nhận quà cảm ơn (NTF-07) + tap → điều hướng màn "Quà đã nhận" (⚠ UPDATE 2026-07-31) | NTF | DOC-v1.0-01 | P3 | Functional | NEW | ✅ Đã tạo TC (+1, 2026-07-31) | — | — |
| SC-NTF-005 | Thông báo khi đơn huỷ (NTF-08) và tin quá hạn (NTF-09) — nhánh huỷ + tap → điều hướng Theo dõi đơn (⚠ UPDATE 2026-07-31); nhánh tin quá hạn (NTF-09) tạm chưa xác nhận hành vi tap | NTF | DOC-v1.0-01 | P2 | Functional | NEW | ✅ Đã tạo TC (+1, 2026-07-31) | — | — |
...
| SC-NTF-007 | Empty state khi chưa có thông báo nào — text "Chưa có thông báo nào" (⚠ UPDATE 2026-07-31, mở rộng C-ORD-06, Resolved — có ảnh chụp thật) | NTF | Ảnh chụp thật app STG | P3 | UI | NEW | ✅ Đã update TC (2026-07-31) | — | — |
...
| SC-NTF-010 | Nội dung push không chứa SĐT (kiểm soát lộ liên hệ, OPR-07, ⚠ NEW 2026-07-30) | NTF | DOC-v1.0-01 | P1 | Business Rule | NEW | ✅ Đã tạo TC | — | — |
| SC-NTF-011 | Icon quay lại tại màn Thông báo (⚠ NEW 2026-07-30) | NTF | Quan sát thực tế app STG | P3 | UI | NEW | ✅ Đã tạo TC | — | — |
